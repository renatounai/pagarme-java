...
public class Transaction extends PagarMeModel<Integer> {
    ...
    public Transaction findByRefenceKey(String referenceKey) throws PagarMeException {

        final PagarMeRequest request = new PagarMeRequest(HttpMethod.GET, String.format("/%s", getClassName()));
        Map<String, Object> params = new HashMap<String, Object>();
        params.put("reference_key", referenceKey);
        request.setParameters(params);
        Transaction other = (Transaction) (JSONUtils.getAsList(super.paginate(defaultCount, defaultPage), new TypeToken<Collection<Transaction>>() {
