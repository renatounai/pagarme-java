...
public class FieldsOnHashTest {
    ...
    public List<FieldsOnHashImpl> list = Arrays.asList(new FieldsOnHashImpl(), new FieldsOnHashImpl());
    public List<String> stringList = Arrays.asList("1", "2");
    public Map<String, Object> map = new HashMap<String, Object>();
    public Map<String, Object> childMap = new HashMap<String, Object>();
    {
    ...
    public void fieldSerialization() {
        ...
        List<String> childStringlist = new ArrayList<String>();
        childStringlist.add("string");

        List<Integer> childIntegerlist = new ArrayList<Integer>();
